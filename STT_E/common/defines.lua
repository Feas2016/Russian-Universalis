...
NGraphics = {
	...
	COLOR_WASTELANDS = 1,							-- If set to 1, wastelands will be colored if a country owns all surrounding provinces STT
	END_OF_COMBAT_GFX = 1
},
...
NFrontend = {
	...
	CAMERA_MIN_HEIGHT = 35.0,			 			-- Minimum camera height STT
