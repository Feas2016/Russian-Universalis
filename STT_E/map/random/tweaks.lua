...
RandomWorld = {
	...
	options = {
		width				= 2304,
		height				= 2304,
		overlapping_sea_province_search_width = 2300, -- Any sea province that overlaps with the randomized area needs to be removed from the provincemap, overlapping_sea_province_search_width is the rightmost edge of the area of the provincemap that will be searched for these provinces
	...
	heightmap_noise = { -- Adds noise to the height map (fBm)
		noise_factor 		= 0.60,	--- STT 0.60
		noise_factor_water 	= 0.30,	--- STT 0.30
	...
	colormap = {
		...
		noise_overlay_percent 	= 0.70,	--- STT 0.70
	...
	colormap_seasons = {
		-- Winter
		season0_overlay_percent			= 0.35,	--- STT 0.35
		season0_color_r					= 200,
		season0_color_g					= 225,
		season0_color_b					= 255,
		
		-- Spring
		season1_overlay_percent			= 0.25,	--- STT 0.25
		season1_color_r					= 180,
		season1_color_g					= 225,
		season1_color_b					= 200,

		-- Summer
		season2_overlay_percent			= 0.1,	--- STT 0.1
		season2_color_r					= 0,
		season2_color_g					= 150,
		season2_color_b					= 0,

		-- Autumn
		season3_overlay_percent			= 0.70,	--- STT 0.70
		season3_color_r					= 150,
		season3_color_g					= 20,
		season3_color_b					= 0,		
	},
